...
function SidebarLink({
  ...
  return (
    ...
    >
      <Icon className="w-8 h-8 shrink-0 ml-1 transition-transform duration-300 ease-in-out" />
      <span
        className="ml-3 text-lg transition-transform duration-300 ease-in-out origin-left overflow-hidden whitespace-nowrap"
