        ...
        <div className="container mx-auto px-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-stretch mb-48 border border-gray-300 rounded-xl shadow-lg p-8 min-h-[700px]">
            ...
            <div className="order-1 lg:order-1 lg:col-span-4 flex flex-col">
              ...
              <p className="text-2xl text-gray-700 mt-auto">
              Our AI breaks down aggregated alumni data into rich, actionable insights—based on any natural language query you provide. Ask questions, visualize trends, and instantly surface patterns that helps you showcase alumni success with clarity.
              </p>
            </div>
