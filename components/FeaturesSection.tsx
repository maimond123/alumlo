      ...
      <section 
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-amber-600 max-w-3xl mx-auto h-16 flex items-center justify-center">
              {typedText}
              {!isTypingComplete && (
                <span className="ml-1 inline-block w-0.5 h-6 bg-amber-600 animate-blink"></span>
              )}
            </p>
          </div>
