          ...
          <div className="flex gap-6 h-[calc(100vh-12rem)]">
            ...
            <div className="w-1/3 bg-white p-6 rounded-lg shadow-md">
              ...
              <button
                ...
                className={`w-full ${
                  isLoading ? "bg-gray-400 cursor-not-allowed" : "bg-emerald-500/0 hover:scale-105 transform transition-transform duration-300"
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="bg-black text-white py-2 px-4 rounded-md hover:scale-105 transform transition-transform duration-300 flex items-center"
                  >
