              ...
              <div className="md:w-1/2 mb-12 md:mb-0">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <button
                    ...
                    className="w-full bg-transparent text-black border border-black px-8 py-4 rounded-full text-xl font-semibold hover:bg-[#FFD700] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mt-8"
                  >
                    {isSubmitting ? (
                      <>
                ...
                >
                  <p className="text-black text-lg">
                    If you would like to request a referral code to demo Alumlo, please email us at{' '}
                    <a href="mailto:david@alumlo.com" className="underline text-teal-500">
                      david@alumlo.com
                    </a>
                    .
                  </p>
