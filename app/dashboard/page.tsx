        ...
        <div className={`min-h-screen flex flex-col items-center px-4 ${
          ...
          {mode === 'learn' && (
            <div className="w-full max-w-3xl flex flex-col h-[70vh]">
              ...
              <div className="flex-1 overflow-y-auto bg-white border border-black rounded-2xl p-6 mb-4 shadow-lg">
              ...
              <form onSubmit={handleLearnSubmit} className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 w-10 h-10 flex items-center justify-center bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
                >
                  {isProcessing ? (
                    <Loader2 className="h-5 w-5 animate-spin" />
                  ) : (
